...
class TopicClass6(models.Model):
...
class TaskClass6(models.Model):
    title = models.CharField(max_length=100, verbose_name="Название задания")
    topic = models.ForeignKey(TopicClass6, on_delete=models.CASCADE, verbose_name='Тема', related_name='tasks')
...
class Choice6(models.Model):
    question = models.ForeignKey(Question6, on_delete=models.CASCADE, verbose_name='Вопрос к которому относится ответ')
...
class Test6(models.Model):
    topic = models.ForeignKey(TopicClass6, on_delete=models.CASCADE, verbose_name='Тема', related_name='tasks_test')
    question = models.ManyToManyField(Question6, verbose_name='Вопрос в тесте', related_name='questions')
...
class TestResult6(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Пользователь')
    test = models.ForeignKey(Test6, on_delete=models.CASCADE, verbose_name='Тест', related_name='test_results')
