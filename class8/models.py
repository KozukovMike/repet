...
class TopicClass8(models.Model):
...
class TaskClass8(models.Model):
    title = models.CharField(max_length=100, verbose_name="Название задания")
    topic = models.ForeignKey(TopicClass8, on_delete=models.CASCADE, verbose_name='Тема', related_name='tasks')
...
class Choice8(models.Model):
    question = models.ForeignKey(Question8, on_delete=models.CASCADE, verbose_name='Вопрос к которому относится ответ')
...
class Test8(models.Model):
    topic = models.ForeignKey(TopicClass8, on_delete=models.CASCADE, verbose_name='Тема', related_name='tasks_test')
    question = models.ManyToManyField(Question8, verbose_name='Вопрос в тесте', related_name='questions')
...
class TestResult8(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Пользователь')
    test = models.ForeignKey(Test8, on_delete=models.CASCADE, verbose_name='Тест', related_name='test_results')
