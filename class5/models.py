...
class Choice5(models.Model):
    question = models.ForeignKey(Question5, on_delete=models.CASCADE, verbose_name='Вопрос к которому относится ответ')
...
class Test5(models.Model):
    ...
    question = models.ManyToManyField(Question5, verbose_name='Вопрос в тесте', related_name='questions')
...
class TestResult5(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Пользователь')
    test = models.ForeignKey(Test5, on_delete=models.CASCADE, verbose_name='Тест', related_name='test_results')
